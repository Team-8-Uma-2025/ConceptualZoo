...
const EnclosureDetails = () => {
  ...
  const handleDelete = async () => {
    ...
    if (
      !window.confirm(
        "Are you sure you want to delete this enclosure? This action can NOT be reversed"
      )
    )
      return;
    try {
    ...
    <div className="bg-gray-100 min-h-screen pt-20">
      <div className="container mx-auto px-4 py-12 font-['Lora']">
        <h1 className="text-3xl font-bold mb-6 font-['Roboto_Flex']">
          Enclosure Management and Details
        </h1>
        <p className="text-sm text-gray-800 italic">
          Search for enclsoure to edit or delete.
        </p>
        ...
        {selectedEnclosure && (
          <div>
            <h2 className="text-2xl font-semibold mb-4 font-['Roboto_Flex']">
              Enclosure: {selectedEnclosure.EnclosureID} Details
            </h2>
            ...
            <h3 className="text-xl font-semibold mb-2 font-['Roboto_Flex']">
              Assigned Animals
            </h3>
            {selectedEnclosure.Animals &&
            selectedEnclosure.Animals.length > 0 ? (
              ...
              <p className="font-['Lora']">
                No animals are assigned to this enclosure.
              </p>
            )}
          </div>
        )}
            ...
            <div className="mb-6">
              ...
              <form onSubmit={handleUpdate}>
                ...
                <div className="flex">
                  <button
                    type="submit"
                    className="bg-blue-600 text-white p-2 rounded mr-2 font-['Mukta_Mahee']"
                  >
                    Save Changes
                  </button>
                  <button
          ...
          <div className="mb-6">
            ...
            <form onSubmit={handleAdd}>
              ...
              <div className="flex">
                <button
                  type="submit"
                  className="bg-green-600 text-white p-2 rounded mr-2 font-['Mukta_Mahee']"
                >
                  Add
                </button>
                <button
